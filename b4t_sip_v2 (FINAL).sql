...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2018 at 01:01 AM
...
(71, 5, '2017-12-10 10:32:21', 'lolos', 'next', 'next', 'coret tv', 'Segera', 'Lolos PPK RM', 1, 1, 1, 1, 2, 'Lolos PPK RM', 1),
...
(84, 6, '2017-12-10 17:31:20', 'Test', '', '', '', 'Segera', 'Test', 0, 0, 0, 1, 2, 'Test', 0);
...
--
ALTER TABLE `form`
  MODIFY `id_form` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
-- AUTO_INCREMENT for table `form_content`
--
ALTER TABLE `form_content`
  MODIFY `id_form_content` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
--
...
--
ALTER TABLE `tracking_history`
  MODIFY `id_catalog` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
--
