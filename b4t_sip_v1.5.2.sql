...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2017 at 08:22 AM
...
(85, 12, '2017-12-10 07:15:06', '', '', '', '', 'Segera', '', 0, 0, 0, 0, 0, '');
...
(3, 'form', 'form', 'fa fa-file-pdf-o', 1, 18),
...
--
ALTER TABLE `form`
  MODIFY `id_form` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
--
