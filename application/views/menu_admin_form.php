<!-- Main content -->
            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='table-responsive'>
                  ...
                  <h3 class='box-title'>MENU_ADMIN</h3>
	    ...
	    <tr><td>Link <?php echo form_error('link') ?></td>
            <td><input type="text" class="form-control" name="link" id="link" placeholder="Name Controller" value="<?php echo $link; ?>" />
        </td>
	    <tr><td>Icon <?php echo form_error('icon') ?></td>
            <td><input type="text" class="form-control" name="icon" id="icon" placeholder="Icon from font awesome 4.4, example > fa fa-usd" value="<?php echo $icon; ?>" />
        </td>
      ...
      <tr><td>Is Parent <?php echo form_error('is_parent') ?></td>
            <td>
                <select name="is_parent" class="form-control">
                    ...
                    foreach ($menu->result() as $m){
                        ...
                        echo">Sub Menu dari ".  strtoupper($m->name)."</option>";
                    }
                    ?>
                </select>
        </td>
	    ...
	    <a href="<?php echo site_url('menu_admin') ?>" class="btn btn-default">Back</a></td></tr>
