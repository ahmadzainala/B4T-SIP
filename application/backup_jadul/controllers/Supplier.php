...
class Supplier extends CI_Controller
{
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
		'id_supplier_category' => $this->input->post('id_supplier_category',TRUE),
    ...
    {
	$this->form_validation->set_rules('id_supplier_category', 'id supplier category', 'trim|required');
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Id Supplier Category");
	...
	foreach ($this->Supplier_model->get_all() as $data) {
	    ...
	    xlsWriteNumber($tablebody, $kolombody++, $data->id_supplier_category);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2017-09-17 10:09:55 */
/* http://harviacode.com */