                ...
                <?php
                  ...
                  if($item_list != ""){
                    foreach ($item_list as $il) {
                      echo "<tr style=''><td>$i</td><td>$il->name_category</td><td>$il->name_items</td><td>$il->quantity</td><td><input type='checkbox' name='$il->id_items_detail' class='acc' value='0' onClick='check($il->id_items_detail)'></td></tr>";
                      $i++;
                    }
                  }else{
