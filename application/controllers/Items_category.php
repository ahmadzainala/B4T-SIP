...
class Items_category extends CI_Controller
{
    ...
    function pdf()
    {
        ...
        $html = $this->load->view('items_category_pdf', $data, true);
        $this->load->library('pdf');
        $pdf = $this->pdf->load();
        $pdf->WriteHTML($html);
        $pdf->Output('items_category.pdf', 'D'); 
    }

}

/* End of file Items_category.php */
/* Location: ./application/controllers/Items_category.php */
