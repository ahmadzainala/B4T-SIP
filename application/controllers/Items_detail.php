...
class Items_detail extends CI_Controller
{
    ...
    function pdf()
    {
        ...
        $html = $this->load->view('items_detail_pdf', $data, true);
        $this->load->library('pdf');
        $pdf = $this->pdf->load();
        $pdf->WriteHTML($html);
        $pdf->Output('items_detail.pdf', 'D'); 
    }

}

/* End of file Items_detail.php */
/* Location: ./application/controllers/Items_detail.php */
