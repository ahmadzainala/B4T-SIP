...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Sep 2017 pada 14.34
...
CREATE TABLE `form` (
  ...
  `status_submit` enum('0','1') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 5, '2017-09-24', 'tes tes', 'Segera', 'dipenuhi secepatnya', 0, 0, 0, ''),
(2, 6, '2017-09-24', 'blablbablbalab', '2017-09-01', 'diadakan untuk keperluan rapat', 0, 0, 0, ''),
(3, 5, '2017-09-24', 'xxxxxxx', 'Segera', 'tes lagi dan lagi', 0, 0, 0, ''),
(9, 5, '2017-09-24', 'zzzzzzzzzzzzzzzzzzzzzzzzzz', '2017-11-20', 'mohon segera di adakan untuk keperluan rapat', 0, 0, 0, ''),
(10, 5, '2017-09-24', 'azzz', '2017-12-22', 'aweuaweuaweu', 0, 0, 0, ''),
(11, 5, '2017-09-24', 'asdasdas', 'Segera', 'kumaha aaa', 0, 0, 0, '');
...
--
-- Dumping data untuk tabel `tracking_catalog`
--
